        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col items-center justify-between mb-6 lg:flex-row">
                ...
                <div class="border-b-2 border-gray-200 dark:border-neutral-700">
                    ...
                    <a class="inline-flex items-center gap-2 px-1 py-4 text-sm text-gray-500 border-b-2 border-transparent whitespace-nowrap hover:text-blue-600 focus:outline-none focus:text-blue-600 dark:text-neutral-500 dark:hover:text-blue-500 dark:focus:text-blue-500" href="#">
                    ...
                    <a class="inline-flex items-center gap-2 px-1 py-4 text-sm font-medium text-blue-600 border-b-2 border-blue-500 whitespace-nowrap focus:outline-none focus:text-blue-800 dark:text-blue-500" href="#" aria-current="page">
                        <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
